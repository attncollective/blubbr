...
export default function Sidebar() {
    return (
        <aside
            className="w-20 md:w-60 xl:w-72 z-20 fixed top-0 left-0 hidden xs:flex"
            aria-label="Sidebar"
        >
            <div className="h-screen shadow-3xl-light dark:shadow-3xl-dark">
                <div className="pl-2 xl:pl-4 pr-3 xl:pr-6 xl:pt-2">
                    ...
                    <ul className="mt-4 xl:mt-8 space-y-2">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="hidden md:inline-flex justify-center items-center p-3 ml-3 w-3 h-3 text-sm font-medium text-gray-200 dark:text-gray-850 bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-500 dark:from-purple-300/80 dark:via-pink-300/80 dark:to-yellow-300/80 rounded-full">
                                    3
                                </span>
                            </a>
                        </li>
